...
const About = () => {
  return (
    <>
          ...
          <div className="home__bannar__heading">
            ...
            <div className="home__bannar__para">
              <p className="home__bannar__para__txt">
                ...
                <br />
                semper metus, nibh adipisci assumenda odio,
                <br />
                quos, senectus vehicula occaecat, officiis malesuada cras.
              </p>
            </div>
      ...
      <div className="home__bannar__heading__txt">
        <h2 className="center">
          I can help you with the following services in MERN Stack.
        </h2>
      </div>
